...
<head>
	...
	<meta name="description" content="Food@Home Cheesecake">
	...
	<title>Food@Home - Berry Cheesecake</title>
...
<body>
	...
	<div class="container pt-3">
		<h3 style="color: yellowgreen">BERRY CHEESECAKE</h3>
		<div class="row">
			<div class="col-4">
				<img alt="Cheesecake" src="Cheesecake.jpeg" style="width:100%" height="250">
			</div>
			<div class="col-4">
				<h5><b>Ingredients</b></h5>
				<ul>
					<li>120 gr biscuits</li>
					<li>90 gr melted butter</li>
					<li>10 g gelatine sheets</li>
					<li>500 gr cream cheese</li>
					<li>300 ml whipping cream</li>
					<li>3 tbsp sugar</li>
					<li>300 gr frozen mixed berries</li>
					<li>2-3 tbsp lemon jiuce</li>
					<li>2-3 tbsp lemon jiuce</li>
				</ul>
			</div>
	...
	%>
		...
		<div class="row pt-2">
			...
			<ol>
				...
				<li>Press mix in cakeform and refrigerate until needed.</li>
				<li>Put the gelatine sheets  in a bowl of water and set aside for 10 minutes.</li>
				<li>Add lemon juice, sugar, salt, to the frozen berries. Stir well and bring to boil. Then add gelatine.</li>
				<li>Beat slightly the whipping cream. Add cream cheese and sugar. Beat until well combined.</li>
				<li>Add the mixed berries mixture and mix.</li>
				<li>Add mixture in cakeform on top of the crushed biscuits, smooth out the top and refrigerate for at least 6 hours covered with tin foil.</li>
			</ol>
		</div>
		<div class="row pt-2">
		...
		<div class="row pt-2">
			<iframe width="715" height="402" src="https://www.youtube.com/embed/6heRoARe72k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</div>
