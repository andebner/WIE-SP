...
<head>
	...
	<meta name="description" content="Food@Home Confirmation">
	...
	<title>Food@Home - Confirmation</title>
	<style>
		#align {
			position: absolute;
			top: 50%;
...
<body>
	...
	<div id="align">
		...
		<button onclick="document.location='Food@Home.jsp'" class="btn btn-outline-success px-4 py-1 mr-2">Back</button>
