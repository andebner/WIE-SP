...
<head>
	...
	<meta name="description" content="Food@Home Strawberry Smoothie">
	...
	<title>Food@Home - Strawberry Smoothie</title>
...
<body>
	...
	<div class="container pt-3">
		<h3 style="color: yellowgreen">STRAWBERRY SMOOTHIE</h3>
		<div class="row">
			<div class="col-4">
				<img alt="Strawberry Smoothie" src="Smoothie2.jpeg" style="width:100%" height="250">
			</div>
			<div class="col-4">
				<h5><b>Ingredients</b></h5>
				<ul>
					<li>355 ml almond milk</li>
					<li>240 g frozen strawberry</li>
					<li>1 large ripe banana pieces</li>
	...
	%>
		...
		<div class="row pt-2">
			...
			<ol>
				<li>In a powerful blender, add almond milk, strawberries, banana and chiaseeds in the exact order.</li>
				<li>Blend until smooth. Serve within a few hours.</li>
			</ol>
		</div>
		<div class="row pt-2">
		...
		<div class="row pt-2">
			<iframe width="715" height="402" src="https://www.youtube.com/embed/GSo-ZTuXrMs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</div>
