...
<head>
	...
	<meta name="description" content="Food@Home SignUp">
...
<body>
	...
	<div class="container">
		<h3 style="color: yellowgreen">Sign Up</h3>
		
		<form class="needs-validation">
				<script src="form-validation.js"></script>
			<div class="row">
				<label for="firstName">First name</label>
				<input type="text" id="firstName" placeholder="Marco" class="w-100 form-control" required>
   				<div class="invalid-feedback">Valid first name is required</div>
   			</div>
   			<div class="row">
   				<label for="lastName">Last name</label>
				<input type="text" id="lastName" placeholder="Bianchi" class="w-100 form-control" required>
    			<div class="invalid-feedback">Valid last name is required</div>
   			</div>
   			<div class="row">
   				<label for="email">Email</label>
				<input type="email" id="email" placeholder="youremail@example.com" class="w-100 form-control" required>
				<div class="invalid-feedback">Valid e-mail is required</div>
   			</div>
   			<div class="row">
   				<label for="tel">Mobile</label>
   				<input type="tel" id="tel" placeholder="+39**********" max="13" class="w-100 form-control">
   			</div>
   			<div class="row">
   				<div class="col-4">
   					<label for="zip">ZIP</label>
   					<input type="number" id="zip" placeholder="39100" max="5" class="w-100 form-control" required>
   					<div class="invalid-feedback">Valid ZIP is required</div>
   				</div>
   				<div class="col-4">
   					<label for="street">Street</label>
   					<input type="text" id="street" class="w-100 form-control" required>
   					<div class="invalid-feedback">Valid street is required</div>
   				</div>
   				<div class="col-4">
   					<label for="hn">House Number</label>
   					<input type="number" id="hn" max="4" class="w-100 form-control" required>
   			...
   			<div class="row">
   				<div class="col-4">
   					...
   					<input type="number" id="cardnumber" class="w-100 form-control" required>
   				...
   				<div class="col-4">
   					...
   					<div class="row" id="ed w-100">
   						<div class="col">
   							<input type="number" max="2" class="form-control" placeholder="23" required>
   						</div>
   						<div class="col">
   							<input type="number" max="2" class="form-control" placeholder="09" required>
   						</div>
   					</div>
   				...
   				<div class="col-4">
   					...
   					<input type="password" max="3" id="code" placeholder="***" class="w-100 form-control" required>
   					<div class="invalid-feedback">Valid code is required</div>
   				</div>
   			</div>
   			<div class="row">
   				<label for="password">Password</label>
   				<input type="password" id="password" class="w-100 form-control" required>
   				<div class="invalid-feedback">Valid password is required</div>
   			</div>
   			<div class="row pt-3">
   				<button type="submit" class="btn btn-outline-success px-4 py-1 mr-2" >Sign Up</button>
   			</div>
		</form>
