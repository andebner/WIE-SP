...
<body>
	...
	<div class="container pt-3">
		<h3 style="color: yellowgreen">Guacamole Eggs</h3>
		<div class="row">
			<div class="col-4">
				<img alt="Guacamole Eggs" src="GuacEgg.jpeg" style="width:100%" height="250">
			</div>
			<div class="col-4">
	...
	%>
		...
		<div class="row pt-2">
			...
			<ol>
				<li>Boil the eggs.</li>
				<li>Cut them in half and seperate the yolks from the whites.</li>
				<li>Smash the peeled avocado with the yolks.</li>
				<li>Add all the other ingredients and mix.</li>
				<li>Put the guacamole in the eggwhites.</li>
			</ol>
		</div>
		<div class="row pt-2">
		...
		<div class="row pt-2">
			<iframe width="715" height="402" src="https://www.youtube.com/embed/l_OcIF9r66E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	</div>
